...
<form action="<?= esc(base_url('user/ubahBarangIT')); ?>" method="post" role="form">
    ...
    <div class="row form-group mb-3">
        ...
        <div class="col-7">
            <select class="form-control selectpicker" name="user_id" value="<?= $barang['user_id'] ?>"  >
    ...
    <div class="row form-group mb-3">
        ...
        <div class="col-7">
            ...
            <select id="jenis_select" class="form-control selectpicker" name="jenis" value="<?= $barang['jenis'] ?>"   required>
                <option class="text-left" value="">Pilih Jenis Barang</option>
                <?php foreach ($jenis_list as $jenis) : ?>
                    <option><?= esc($jenis['jenis']) ?></option>
                <?php endforeach; ?>
           </select>
    ...
    <div class="row form-group mb-3">
        ...
        <div class="col-7">
            ...
            <select class="form-control selectpicker" name="lokasi" value="<?= $barang['lokasi'] ?>"   required>
                <option class="text-center" value="">Pilih Lokasi Barang</option>
                
                <?php foreach ($room_list as $room) : ?>
                    <option value="<?=$room?>"><?= $room ?></option>
                            <script>console.log('<?=$room?>');</script>
