                ...
                <form action="<?= route_to('login') ?>" method="post" role="form">
                    ...
                    <?php if ($config->validFields === ['email']) : ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="Email" name="login" placeholder="<?= lang('Auth.email') ?>" aria-label="Email" aria-describedby="email-addon">
                    ...
                    <?php if ($config->validFields === ['username']) : ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="Username" name="login" placeholder="<?= lang('Auth.name') ?>" aria-label="Name" aria-describedby="name-addon">
                            <div class="invalid-feedback">
                                <?= session('errors.login') ?>
                            </div>
                        </div>
